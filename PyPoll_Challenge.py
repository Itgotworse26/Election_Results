...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (vote_count > largest_county_population) and (vote_percentage > largest_county_turnout):
            largest_county_population = vote_count
            largest_county_name = county_name
            largest_county_turnout = vote_percentage
